<div class="row">
    ...
    <div class="col-md-6 text-end">
        <a class="btn mb-1 btn-rounded btn-light text-dark font-medium text-dark" data-bs-toggle="tooltip"
           title="Widgets" href="#">
...
<div class="row">
    <div class="col-12 card py-3">
        <div class="row">
            <div class="col-md-6">
                <a href="/employee/profile/new" class="btn bg-primary-subtle ms-2">
            ...
            <div class="col-md-6 text-end">
                <div class="input-group">
                    @if ($data['filterCount'])
                        <input class="form-control form-control" name="data[search]" value=""
                               placeholder="{{ 'Search disabled' }}" disabled="disabled">
                    ...
                    @else
                        <input class="form-control form-control" name="filters[name][like]" value="{{ isset($filters['name']['like']) ? $filters['name']['like'] : '' }}" placeholder="{{ 'Search for...' }}">
